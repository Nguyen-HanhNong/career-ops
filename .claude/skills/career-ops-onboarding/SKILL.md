---
name: career-ops-onboarding
description: First-run onboarding for career-ops -- guides a new user through CV, profile, portals, and tracker setup. Use when `node doctor.mjs --json` reports `onboardingNeeded: true`.
license: MIT
---

# career-ops -- First Run Onboarding
