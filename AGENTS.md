...
**If `onboardingNeeded` is true, invoke the `career-ops-onboarding` skill** and do NOT proceed with evaluations, scans, or any other mode until it reports the basics are in place.
...
**Contributing/governance:** see `CONTRIBUTING.md`, `GOVERNANCE.md`, `CODE_OF_CONDUCT.md`, `SECURITY.md`, `SUPPORT.md`. Discord: https://discord.gg/8pRpHETxa4
...
**Canonical states — see `templates/states.yml` (source of truth) for the full list, aliases, and formatting rules.**
